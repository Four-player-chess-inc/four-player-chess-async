...
use four_player_chess_async::GameBootstrap;
...
async fn player_process(ident: Ident, game: Arc<Mutex<GameBootstrap>>) {
...
#[tokio::main]
async fn main() {
    let game = Arc::new(Mutex::new(GameBootstrap::new(ChessClock::default())));
